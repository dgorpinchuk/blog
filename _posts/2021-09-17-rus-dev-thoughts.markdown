...
Потом слушаешь подобный бред в видео ниже и понимаешь, насколько чиновники далеки от современного интернета, ИТ компаний, как всё устроено и работает.
{: .notice--warning}
{% include video id="_hlx_pcCJK0" provider="youtube" %}